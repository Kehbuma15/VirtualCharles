  ...
  return (
    <div className='flex flex-col items-center mt-6 lg:mt-20'>
        <h1 className='text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide'>
            VirtualCharles build tools
            <span className='bg-gradient-to-r from-purple-500 to-purple-900 text-transparent bg-clip-text'> {" "}for developers</span> 
        </h1>
        ...
        <div className="flex justify-center my-10">
            <a href="#" className='bg-gradient-to-r py-3 px-4 from-purple-500 to-purple-900 rounded-md'>
                Start for free
            </a>
        ...
        <div className='flex mt-10 justify-center '>
            ...
            <video autoPlay loop muted className='rounded-lg w-1/2 border border-purple-700 mx-3'>
